...
<?php
        ...
        //Euro Documentation
        $MbrId="9";                                                                         //Member Id
        $MerchantID="9257626";                                                               //Language_MerchantID
        $MerchantPass="W2e8R4X1";                                                           //Language_MerchantPass
        $UserCode="admin.fidentia";                                                                   //User Code
        ...
        // $FailUrl="https://mysig.al/transaction-failed?policy_id={$data['policy_id']}&id={$user['id']}";       
