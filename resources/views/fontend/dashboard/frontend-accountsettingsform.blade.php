...
<form role="form">
    <div class="container">
        ...
        <div class="form-group">
            <input type="text" class="form-control" id="exampleInputFirstName1" placeholder="Last Name">
        </div>
        <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input type="number" class="form-control" id="exampleInputFirstName1" placeholder="Contact Number" min="0" max="9">
                </div>
            </div>
        </div>
        <div class="form-group">
