	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .text-and-icon-carousel' => 'max-width: {{SIZE}}{{UNIT}}',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .owl-carousel.text-and-icon-carousel:not(.class-1):not(.class-2) .dt-owl-item-inner .dt-slide-button'       => 'background: {{VALUE}};',
					'{{WRAPPER}} .owl-carousel.text-and-icon-carousel:not(.class-1):not(.class-2) .dt-owl-item-inner .dt-slide-button:hover' => 'background: {{VALUE}};',
					'{{WRAPPER}} .owl-carousel.text-and-icon-carousel:not(.class-1):not(.class-2) .dt-owl-item-inner .dt-slide-button:focus' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					{{WRAPPER}} .owl-carousel.text-and-icon-carousel:not(.class-1):not(.class-2) .box-hover:hover .dt-slide-button' => 'background: {{VALUE}};',
					'{{WRAPPER}} .owl-carousel.text-and-icon-carousel:not(.class-1):not(.class-2) .elements-hover .dt-owl-item-inner .dt-slide-button:hover' => 'background: {{VALUE}};',
					'{{WRAPPER}} .owl-carousel.text-and-icon-carousel:not(.class-1):not(.class-2) .dt-owl-item-inner .dt-slide-button:focus' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}  .owl-carousel.text-and-icon-carousel .box-hover:hover .dt-slide-button' => 'border-color: {{VALUE}} !important',
					'{{WRAPPER}}  .owl-carousel.text-and-icon-carousel .elements-hover .dt-slide-button:hover' => 'border-color: {{VALUE}} !important',
